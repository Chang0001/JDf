...
public class HomeDealsAdapter extends BaseAdapter
{
	...
	public HomeDealsAdapter(List<DealsActItemModel> listModel, Activity activity)
	{
	...
	public View getView(int position, View convertView, ViewGroup parent)
	{
		...
		if (convertView == null)
		{
			...
			convertView = mActivity.getLayoutInflater().inflate(R.layout.item_lsv_borrow_invest, null);
			holder.mPgbProgress = (RoundProgressBar) convertView.findViewById(R.id.item_lsv_borrow_invest_pgb_borrow_progress);
			holder.mTxtAmountOfMoney = (TextView) convertView.findViewById(R.id.item_lsv_borrow_invest_txt_amount_of_money);
			holder.mTxtAmountOfMoneyLabel = (TextView) convertView.findViewById(R.id.item_lsv_borrow_invest_txt_amount_of_money_label);
			holder.mTxtProjectName = (TextView) convertView.findViewById(R.id.item_lsv_borrow_invest_txt_borrow_name);
			holder.mTxtRate = (TextView) convertView.findViewById(R.id.item_lsv_borrow_invest_txt_borrow_rate_year);
			holder.mTxtRateLabel = (TextView) convertView.findViewById(R.id.item_lsv_borrow_invest_txt_borrow_rate_year_label);
			holder.mTxtStatus = (TextView) convertView.findViewById(R.id.item_lsv_borrow_invest_txt_borrow_status);
			holder.mTxtTimeLimit = (TextView) convertView.findViewById(R.id.item_lsv_borrow_invest_txt_time_limit);
			holder.mTxtTimeLimitLabel = (TextView) convertView.findViewById(R.id.item_lsv_borrow_invest_txt_time_limit_label);
			holder.mLinBottom = (LinearLayout) convertView.findViewById(R.id.item_lsv_borrow_invest_lin_bottom);
		...
		if (model != null)
		{
			...
			holder.mLinBottom.setBackgroundResource(R.drawable.layer_lsv_item_bottom);
			// ------设置默认进度条-----
			...
			if (model.isSelect())
			{
				holder.mTxtAmountOfMoneyLabel.setTextColor(mActivity.getResources().getColor(color.white));
				holder.mTxtRateLabel.setTextColor(mActivity.getResources().getColor(color.white));
				holder.mTxtTimeLimitLabel.setTextColor(mActivity.getResources().getColor(color.white));
				holder.mTxtAmountOfMoney.setTextColor(mActivity.getResources().getColor(color.white));
				holder.mTxtRate.setTextColor(mActivity.getResources().getColor(color.white));
				holder.mTxtTimeLimit.setTextColor(mActivity.getResources().getColor(color.white));
				holder.mPgbProgress.setTextColor(mActivity.getResources().getColor(color.white));
				holder.mLinBottom.setBackgroundResource(R.drawable.layer_lsv_item_bottom_select);
			}
