...
public class RepayBorrowRepayListAdapter extends BaseAdapter
{
	...
	public RepayBorrowRepayListAdapter(List<Uc_Quick_RefundActLoan_ListModel> listModel, Activity activity, RepayBorrowRepayListAdapterListener listener)
	{
	...
	public View getView(int position, View convertView, ViewGroup parent)
	{
		...
		if (model != null)
		{
			...
			{
				holder.mTxtMonthNeedAllRepayMoney.setText("未找到");
			}
			...
			{
				holder.mTxtRepayDay.setText("未找到");
			}
			...
			{
				holder.mTxtMonthHasRepayMoney.setText("未找到");
			}
			...
			{
				holder.mTxtMonthManageMoney.setText("未找到");
			}
			...
			{
				holder.mTxtMonthRepayMoney.setText("未找到");
			}
			...
			{
				holder.mTxtMonthOverdueFees.setText("未找到");
			}
	...
	class ItemCheck_OnClickListener implements OnClickListener
	{
		...
		private RepayBorrowRepayListAdapter.ViewHolder nHolder = null;

		public ItemCheck_OnClickListener(int nPosition, RepayBorrowRepayListAdapter.ViewHolder holder)
		{
			super();
	...
	private void doNormalToggle(int pos, RepayBorrowRepayListAdapter.ViewHolder holder)
	{
