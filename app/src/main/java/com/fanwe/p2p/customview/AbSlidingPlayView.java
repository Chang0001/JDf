...
import com.fanwe.p2p.adapter.AbViewPagerAdapter;
...
public class AbSlidingPlayView extends LinearLayout
{
	...
	public void initView(Context context)
	{
		...
		displayImage = BitmapFactory.decodeResource(getResources(), R.drawable.ic_main_dot2_foused);
		hideImage = BitmapFactory.decodeResource(getResources(), R.drawable.ic_main_dot2_normal);
