...
import com.jeremyfeinstein.slidingmenu.lib.SlidingMenu.OnToggledListener;
...
public class CustomViewAbove extends ViewGroup
{
	...
	private int mStatusBarHeight = -999; // add by sunday
	...
	private OnToggledListener mOnToggledListener;
	...
	public void setOnToggledListener(OnToggledListener l)
	{
		mOnToggledListener = l;
	}
	...
	{
		if (mStatusBarHeight == -999)
		{
			mStatusBarHeight = mActivity.findViewById(Window.ID_ANDROID_CONTENT).getTop();
		}
		Rect rect = new Rect();
	...
	void smoothScrollTo(int x, int y, int velocity)
	{
		...
		if (dx == 0 && dy == 0)
		{
			...
			if (mOnToggledListener != null)
			{
				mOnToggledListener.onToggled();
			}
			return;
		}
